  ...
  return (
    <div className="w-full max-w-md">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-1">{t("auth.login_title")}</h1>
        <p className="text-gray-500 text-sm mb-6">{t("auth.login_sub")}</p>
        ...
        <p className="text-sm text-gray-500 text-center mt-5">
          {t("auth.no_account")}{" "}
          <Link href={`/${locale}/auth/register`} className="text-blue-600 font-medium hover:underline">
            {t("nav.register")}
          </Link>
        </p>
      </div>
