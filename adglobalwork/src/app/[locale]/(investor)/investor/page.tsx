...
export default async function InvestorDashboard({ params }: Props) {
  ...
  return (
    <div>
      ...
      <p className="text-gray-500 mb-8">Yatırımcı paneline hoş geldiniz.</p>

      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          { label: "İzlenen Projeler", value: "0", color: "amber" },
          { label: "Mesajlar", value: "0", color: "blue" },
          { label: "Talepler", value: "0", color: "emerald" },
        ].map((s) => (
